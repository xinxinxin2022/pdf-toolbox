...
export const tools: ToolDefinition[] = [
  {
    ...
    descriptionKey: 'tools.sign.description',
    icon: '✍️',
    category: 'edit',
    keywords: ['sign pdf', 'pdf signature', 'electronic signature', 'esign pdf', 'sign pdf online free'],
    seoTitleKey: 'tools.sign.seoTitle',
    seoDescKey: 'tools.sign.seoDesc',
    component: lazy(() => import('@/pages/PdfSign')),
    acceptTypes: ['.pdf', 'application/pdf'],
    multiple: false,
    featuresKey: 'features.sign',
    howToUseKey: 'howToUse.sign',
    whyUseKey: 'whyUse.sign',
    faqKey: 'faq.sign',
  ...
  {
    slug: 'pdf-to-excel',
    nameKey: 'tools.pdf-to-excel.name',
    shortDescKey: 'tools.pdf-to-excel.shortDesc',
    descriptionKey: 'tools.pdf-to-excel.description',
    icon: '📊',
    category: 'convert',
    keywords: ['pdf to excel', 'pdf to csv', 'extract table from pdf', 'pdf to spreadsheet online free'],
    seoTitleKey: 'tools.pdf-to-excel.seoTitle',
    seoDescKey: 'tools.pdf-to-excel.seoDesc',
    component: lazy(() => import('@/pages/PdfToExcel')),
    acceptTypes: ['.pdf', 'application/pdf'],
    multiple: false,
    featuresKey: 'features.pdf-to-excel',
    howToUseKey: 'howToUse.pdf-to-excel',
    whyUseKey: 'whyUse.pdf-to-excel',
    faqKey: 'faq.pdf-to-excel',
    gradient: 'from-green-600 to-emerald-500',
  },
  {
    slug: 'word-to-pdf',
    nameKey: 'tools.word-to-pdf.name',
    shortDescKey: 'tools.word-to-pdf.shortDesc',
    descriptionKey: 'tools.word-to-pdf.description',
    icon: '📄',
    category: 'convert',
    keywords: ['word to pdf', 'docx to pdf', 'convert word to pdf', 'word to pdf online free'],
    seoTitleKey: 'tools.word-to-pdf.seoTitle',
    seoDescKey: 'tools.word-to-pdf.seoDesc',
    component: lazy(() => import('@/pages/WordToPdf')),
    acceptTypes: ['.docx', 'application/vnd.openxmlformats-officedocument.wordprocessingml.document'],
    multiple: false,
    featuresKey: 'features.word-to-pdf',
    howToUseKey: 'howToUse.word-to-pdf',
    whyUseKey: 'whyUse.word-to-pdf',
    faqKey: 'faq.word-to-pdf',
